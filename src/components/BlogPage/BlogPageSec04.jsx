            ...
            {result != 0 && result2==0  ? (
                  <div className="flex justify-center items-center w-full mt-[24px]">
                      ...
                      classNames={{
                        ...
                        next:"text-[#FF5941] data-[disabled=true]:border-default-300 data-[disabled=true]:text-default-300 rounded-full w-[48px] h-[48px] border-[1px] border-[#FF5941] bg-transparent transition-all duration-300",
                    ...
                    classNames={{
                      ...
                      cursor:
                        "text-[#fcfcfc] bg-[#FF5941] rounded-full w-[48px] h-[48px] border-[1px] border-[#FF5941] ",
                      next:"text-[#FF5941] data-[disabled=true]:border-default-300 data-[disabled=true]:text-default-300 data-[disabled=true]:border-[#BEBEBE] data-[disabled=true]:text-[#BEBEBE] rounded-full w-[48px] h-[48px] border-[1px] border-[#FF5941] bg-transparent transition-all duration-300",
                      prev:"text-[#FF5941] data-[disabled=true]:border-default-300 data-[disabled=true]:text-default-300 data-[disabled=true]:border-[#BEBEBE] data-[disabled=true]:text-[#BEBEBE] rounded-full w-[48px] h-[48px] border-[1px] border-[#FF5941] bg-transparent  transition-all duration-300",
                      }}
                    page={currentPage}
                    onChange={handlePageChange}
