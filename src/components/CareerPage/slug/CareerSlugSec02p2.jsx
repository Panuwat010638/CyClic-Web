...
export default function CareerSlugSec02p2() {
  return (
    <section className={`bg-[#fcfcfc]`}>
        <div className='max-w-7xl mx-auto px-6 xl:px-0 pb-[56px]'>
            <div className='flex flex-col justify-center items-center w-full h-full gap-y-[24px] sm:gap-y-[36px] lg:gap-y-[48px]'>
