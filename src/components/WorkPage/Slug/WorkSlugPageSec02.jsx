          ...
          <div className='flex flex-col lg:flex-row w-full items-center gap-[24px] h-full relative'>
              ...
              <div className='flex flex-col w-full sm:w-[592px] lg:w-[520px] lg:h-full gap-y-[24px]'>
                ...
                {data?.category == 'Software Development' ? (
                  <a href={data?.header?.link} target="_blank" className="flex justify-center items-center w-full ss:w-[200px] lg:w-[140px] h-[48px]  border-[2px] border-[#161616] hover:bg-[#FB602F]
