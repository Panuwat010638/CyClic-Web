    ...
    <section className="bg-[#fcfcfc]">
        <div className='max-w-7xl mx-auto px-6 xl:px-0 pt-[40px] pb-[56px] lg:pb-[88px] lg:pt-[86px]'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                {/* Content */}
                <div className='flex flex-col justify-center lg:justify-between w-full sm:w-[592px] lg:w-full h-full gap-[72px]'>
                    {/* top */}
                    ...
                    {/* bot */}
                    <div className="flex w-full overflow-hidden relative gap-x-[24px]">
