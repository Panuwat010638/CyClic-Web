...
export default function HomePageSec04ButtonM({data}) {
  return (
    <section className="bg-[#fcfcfc] block lg:hidden">
      <div className="max-w-7xl mx-auto px-6 xl:px-0 pb-[72px] lg:pb-[114px]">
        <div className='flex flex-col justify-center items-center w-full h-full gap-y-[44px] lg:gap-y-[72px]'>

       
          {/* Button M */}
          <div className="group flex lg:hidden justify-between ss:justify-start items-center gap-x-[14px] pb-[20px] w-full ss:w-auto border-b-[1px] border-[#939393]">
