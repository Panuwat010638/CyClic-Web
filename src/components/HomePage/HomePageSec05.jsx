            ...
            <div className="hidden lg:flex flex-col w-full lg:w-[480px] lg:gap-y-[48px]">
              <div className="flex flex-col w-full gap-y-[8px]">
                ...
                <div className="flex items-center gap-x-[16px]">
                  ...
                  >
                    <path
                      d="M24.9259 12.8633H1"
                      stroke="#FB602F"
                      stroke-width="2"
                      stroke-linecap="round"
                    />
                    <path
                      d="M12.9961 25L12.9961 1"
                      stroke="#FB602F"
                      stroke-width="2"
                      stroke-linecap="round"
                    />
                    <path
                      d="M21.4776 21.4863L4.50781 4.51657"
                      stroke="#FB602F"
                      stroke-width="2"
                      stroke-linecap="round"
                    />
                    <path
                      d="M21.4776 4.51657L4.50781 21.4863"
                      stroke="#FB602F"
                      stroke-width="2"
                      stroke-linecap="round"
                    />
              ...
              <svg
                className="hidden lg:flex min-w-[109px] min-h-[109px] animate-spin-slow"
                width="109"
                height="109"
                viewBox="0 0 109 109"
                fill="none"
              ...
              >
                <g opacity="0.3">
                  <path
                    d="M94.7825 53.4844H14.2173"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M54.6096 94.3555L54.6096 13.5408"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M70.1211 16.6458L39.0864 91.2598"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M83.1748 82.5234L26.033 25.3816"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M83.1748 25.3816L26.033 82.5234"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M39.1878 16.6049L70.02 91.3027"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M16.8708 39.5037L92.3369 68.4043"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                  <path
                    d="M17.3485 69.5938L91.8594 38.3125"
                    stroke="#FF2F12"
                    stroke-width="1.35404"
                  />
                </g>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center flex-row w-full gap-[24px]"
      >
